...
class MikoEcommerceChannel(models.Model):
    ...
    unmapped_tax_policy = fields.Selection(
        ...
        help="What to do when Shopify sends a tax with no Odoo equivalent "
             "configured.\n\n"
             "Stop and ask is the default because the alternative is invoices that "
             "are quietly short by the tax amount, which nobody notices until a "
             "return is filed.")
